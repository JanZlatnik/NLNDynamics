...
MODULE RCModel1
    ...
    REAL(KIND = idk) FUNCTION VLCP(R)
        ...
        REAL(KIND = idk), PARAMETER :: LCP_Delta_A = 3.898961023894516d-02
        REAL(KIND = idk), PARAMETER :: LCP_Delta_alpha = 8.735602973541983d-01
        REAL(KIND = idk), PARAMETER :: LCP_Delta_Rc = 1.089000978692283d+00
    ...
    REAL(KIND = idk) FUNCTION GammaLCP(R)
        ...
        ! --- E_res ---
        REAL(KIND = idk), PARAMETER :: LCP_E_res_const = 4.382149213957109d-02
        REAL(KIND = idk), PARAMETER :: LCP_E_res_A = -1.701164678251178d-01
        REAL(KIND = idk), PARAMETER :: LCP_E_res_alpha = 5.624798348438760d-01
        REAL(KIND = idk), PARAMETER :: LCP_E_res_Rc = 1.773857666427101d+00
        REAL(KIND = idk), PARAMETER :: LCP_E_res_B = 2.041864388505123d-03
        REAL(KIND = idk), PARAMETER :: LCP_E_res_beta = 2.916421139601274d-01

        ! --- Gamma ---
        REAL(KIND = idk), PARAMETER :: LCP_Gamma_A = 1.259082223726381d+02
        REAL(KIND = idk), PARAMETER :: LCP_Gamma_B = -1.258583510156559d+02
        REAL(KIND = idk), PARAMETER :: LCP_Gamma_beta = -1.477140326273967d-04
        REAL(KIND = idk), PARAMETER :: LCP_Gamma_gamma_exp = -6.340824358634510d-02
